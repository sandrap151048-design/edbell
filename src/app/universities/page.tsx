  ...
  const fetchUniversities = async () => {
    try {
      ...
      if (data.success && data.universities && data.universities.length > 0) {
        ...
        const fallbackUniversities: University[] = [
          {
            ...
            description: 'Indira Gandhi National Open University - India\'s largest distance education university offering flexible learning opportunities.',
            accreditation: 'NAAC A++',
            established: '1985',
            location: 'New Delhi, India',
            website: 'https://www.ignou.ac.in',
            ranking: '#1 Distance Education',
            studentsCount: '2M+',
            coursesOffered: 500,
            specialization: ['Distance Education', 'Online Learning', 'Flexible Schedules'],
            rating: 4.8
          },
          {
            ...
            studentsCount: '30K+',
            coursesOffered: 200,
            specialization: ['Engineering', 'Management', 'Liberal Arts'],
            rating: 4.7
          },
          {
            ...
            studentsCount: '25K+',
            coursesOffered: 150,
            specialization: ['Technology', 'Business', 'Online Programs'],
            rating: 4.6
          },
          {
          ...
          },
          {
            ...
            studentsCount: '35K+',
            coursesOffered: 250,
            specialization: ['Engineering', 'Medicine', 'Management'],
            rating: 4.8
          },
          {
        ...
        console.warn('Using fallback university data - database may be empty');
      }
    } catch (error) {
